...
@.str.1 = private unnamed_addr constant [8 x i8] c"_e && p\00", align 1
@.str.2 = private unnamed_addr constant [29 x i8] c"./dummy_inc/click/element.hh\00", align 1
...
define dso_local void @_ZN13MyNullElement4pushEiP6Packet(%class.MyNullElement* %0, i32 %1, %class.Packet* %2) unnamed_addr #2 align 2 !dbg !1204 {
  ...
  tail call void @_ZNK7Element19checked_output_pushEiP6Packet(%class.Element* %4, i32 0, %class.Packet* %2), !dbg !1211
  ret void, !dbg !1212
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNK7Element19checked_output_pushEiP6Packet(%class.Element* %0, i32 %1, %class.Packet* %2) local_unnamed_addr #3 comdat align 2 !dbg !1213 {
  %4 = alloca %class.Element*, align 8
  %5 = alloca i32, align 4
  %6 = alloca %class.Packet*, align 8
  store %class.Element* %0, %class.Element** %4, align 8, !tbaa !1224
  call void @llvm.dbg.declare(metadata %class.Element** %4, metadata !1220, metadata !DIExpression()), !dbg !1228
  store i32 %1, i32* %5, align 4, !tbaa !1229
  call void @llvm.dbg.declare(metadata i32* %5, metadata !1222, metadata !DIExpression()), !dbg !1231
  store %class.Packet* %2, %class.Packet** %6, align 8, !tbaa !1224
  call void @llvm.dbg.declare(metadata %class.Packet** %6, metadata !1223, metadata !DIExpression()), !dbg !1232
  %7 = load %class.Element*, %class.Element** %4, align 8
  %8 = load i32, i32* %5, align 4, !dbg !1233, !tbaa !1229
  %9 = call i32 @_ZNK7Element8noutputsEv(%class.Element* %7), !dbg !1235
  %10 = icmp ult i32 %8, %9, !dbg !1236
  br i1 %10, label %11, label %19, !dbg !1237

11:                                               ; preds = %3
  %12 = getelementptr inbounds %class.Element, %class.Element* %7, i32 0, i32 1, !dbg !1238
  %13 = getelementptr inbounds [2 x %"class.Element::Port"*], [2 x %"class.Element::Port"*]* %12, i64 0, i64 1, !dbg !1238
  %14 = load %"class.Element::Port"*, %"class.Element::Port"** %13, align 8, !dbg !1238, !tbaa !1224
  %15 = load i32, i32* %5, align 4, !dbg !1239, !tbaa !1229
  %16 = sext i32 %15 to i64, !dbg !1238
  %17 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %14, i64 %16, !dbg !1238
  %18 = load %class.Packet*, %class.Packet** %6, align 8, !dbg !1240, !tbaa !1224
  call void @_ZNK7Element4Port4pushEP6Packet(%"class.Element::Port"* %17, %class.Packet* %18), !dbg !1241
  br label %21, !dbg !1238

19:                                               ; preds = %3
  %20 = load %class.Packet*, %class.Packet** %6, align 8, !dbg !1242, !tbaa !1224
  call void @_ZN6Packet4killEv(%class.Packet* %20), !dbg !1243
  br label %21
...
define linkonce_odr dso_local void @_ZN13MyNullElementD0Ev(%class.MyNullElement* %0) unnamed_addr #5 comdat align 2 !dbg !1245 {
  call void @llvm.dbg.value(metadata %class.MyNullElement* %0, metadata !1247, metadata !DIExpression()), !dbg !1248
  %2 = bitcast %class.MyNullElement* %0 to %class.Element*, !dbg !1249
  tail call void @_ZN7ElementD2Ev(%class.Element* %2) #10, !dbg !1249
  %3 = bitcast %class.MyNullElement* %0 to i8*, !dbg !1249
  tail call void @_ZdlPv(i8* %3) #11, !dbg !1249
  ret void, !dbg !1250
}
...
define linkonce_odr dso_local i32 @_ZNK7Element8noutputsEv(%class.Element* %0) local_unnamed_addr #7 comdat align 2 !dbg !1251 {
  call void @llvm.dbg.value(metadata %class.Element* %0, metadata !1256, metadata !DIExpression()), !dbg !1257
  %2 = getelementptr inbounds %class.Element, %class.Element* %0, i64 0, i32 3, i64 1, !dbg !1258
  %3 = load i32, i32* %2, align 4, !dbg !1258, !tbaa !1229
  ret i32 %3, !dbg !1259
}

; Function Attrs: noinline optnone uwtable
define linkonce_odr dso_local void @_ZNK7Element4Port4pushEP6Packet(%"class.Element::Port"* %0, %class.Packet* %1) local_unnamed_addr #3 comdat align 2 !dbg !1260 {
  %3 = alloca %"class.Element::Port"*, align 8
  %4 = alloca %class.Packet*, align 8
  store %"class.Element::Port"* %0, %"class.Element::Port"** %3, align 8, !tbaa !1224
  call void @llvm.dbg.declare(metadata %"class.Element::Port"** %3, metadata !1294, metadata !DIExpression()), !dbg !1297
  store %class.Packet* %1, %class.Packet** %4, align 8, !tbaa !1224
  call void @llvm.dbg.declare(metadata %class.Packet** %4, metadata !1296, metadata !DIExpression()), !dbg !1298
  %5 = load %"class.Element::Port"*, %"class.Element::Port"** %3, align 8
  %6 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %5, i32 0, i32 0, !dbg !1299
  %7 = load %class.Element*, %class.Element** %6, align 8, !dbg !1299, !tbaa !1300
  %8 = icmp ne %class.Element* %7, null, !dbg !1299
  br i1 %8, label %9, label %12, !dbg !1299

9:                                                ; preds = %2
  %10 = load %class.Packet*, %class.Packet** %4, align 8, !dbg !1299, !tbaa !1224
  %11 = icmp ne %class.Packet* %10, null, !dbg !1299
  br label %12

12:                                               ; preds = %9, %2
  %13 = phi i1 [ false, %2 ], [ %11, %9 ], !dbg !1297
  br i1 %13, label %14, label %15, !dbg !1299

14:                                               ; preds = %12
  br label %16, !dbg !1299

15:                                               ; preds = %12
  call void @__assert_fail(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.2, i64 0, i64 0), i32 611, i8* getelementptr inbounds ([41 x i8], [41 x i8]* @__PRETTY_FUNCTION__._ZNK7Element4Port4pushEP6Packet, i64 0, i64 0)) #12, !dbg !1299
  unreachable, !dbg !1299

16:                                               ; preds = %14
  %17 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %5, i32 0, i32 0, !dbg !1302
  %18 = load %class.Element*, %class.Element** %17, align 8, !dbg !1302, !tbaa !1300
  %19 = getelementptr inbounds %"class.Element::Port", %"class.Element::Port"* %5, i32 0, i32 1, !dbg !1303
  %20 = load i32, i32* %19, align 8, !dbg !1303, !tbaa !1304
  %21 = load %class.Packet*, %class.Packet** %4, align 8, !dbg !1305, !tbaa !1224
  %22 = bitcast %class.Element* %18 to void (%class.Element*, i32, %class.Packet*)***, !dbg !1306
  %23 = load void (%class.Element*, i32, %class.Packet*)**, void (%class.Element*, i32, %class.Packet*)*** %22, align 8, !dbg !1306, !tbaa !1307
  %24 = getelementptr inbounds void (%class.Element*, i32, %class.Packet*)*, void (%class.Element*, i32, %class.Packet*)** %23, i64 2, !dbg !1306
  %25 = load void (%class.Element*, i32, %class.Packet*)*, void (%class.Element*, i32, %class.Packet*)** %24, align 8, !dbg !1306
  call void %25(%class.Element* %18, i32 %20, %class.Packet* %21), !dbg !1306
  ret void, !dbg !1309
}

declare dso_local void @_ZN6Packet4killEv(%class.Packet*) local_unnamed_addr #6
...
!134 = !DIFile(filename: "/usr/include/clang/11.0.0/include/stddef.h", directory: "")
...
!1211 = !DILocation(line: 10, column: 5, scope: !1204)
!1212 = !DILocation(line: 11, column: 1, scope: !1204)
!1213 = distinct !DISubprogram(name: "checked_output_push", linkageName: "_ZNK7Element19checked_output_pushEiP6Packet", scope: !1172, file: !1173, line: 700, type: !1214, scopeLine: 701, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1218, retainedNodes: !1219)
!1214 = !DISubroutineType(types: !1215)
!1215 = !{null, !1216, !34, !78}
...
!1218 = !DISubprogram(name: "checked_output_push", linkageName: "_ZNK7Element19checked_output_pushEiP6Packet", scope: !1172, file: !1173, line: 48, type: !1214, scopeLine: 48, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1219 = !{!1220, !1222, !1223}
!1220 = !DILocalVariable(name: "this", arg: 1, scope: !1213, type: !1221, flags: DIFlagArtificial | DIFlagObjectPointer)
!1221 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1217, size: 64)
!1222 = !DILocalVariable(name: "port", arg: 2, scope: !1213, file: !1173, line: 700, type: !34)
!1223 = !DILocalVariable(name: "p", arg: 3, scope: !1213, file: !1173, line: 700, type: !78)
...
!1230 = !{!"int", !1226, i64 0}
!1231 = !DILocation(line: 700, column: 34, scope: !1213)
!1232 = !DILocation(line: 700, column: 48, scope: !1213)
!1233 = !DILocation(line: 702, column: 20, scope: !1234)
!1234 = distinct !DILexicalBlock(scope: !1213, file: !1173, line: 702, column: 9)
!1235 = !DILocation(line: 702, column: 38, scope: !1234)
!1236 = !DILocation(line: 702, column: 25, scope: !1234)
!1237 = !DILocation(line: 702, column: 9, scope: !1213)
!1238 = !DILocation(line: 703, column: 9, scope: !1234)
!1239 = !DILocation(line: 703, column: 19, scope: !1234)
!1240 = !DILocation(line: 703, column: 30, scope: !1234)
!1241 = !DILocation(line: 703, column: 25, scope: !1234)
!1242 = !DILocation(line: 705, column: 9, scope: !1234)
!1243 = !DILocation(line: 705, column: 12, scope: !1234)
!1244 = !DILocation(line: 706, column: 1, scope: !1213)
!1245 = distinct !DISubprogram(name: "~MyNullElement", linkageName: "_ZN13MyNullElementD0Ev", scope: !1168, file: !1169, line: 8, type: !1175, scopeLine: 8, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1178, retainedNodes: !1246)
!1246 = !{!1247}
!1247 = !DILocalVariable(name: "this", arg: 1, scope: !1245, type: !1207, flags: DIFlagArtificial | DIFlagObjectPointer)
!1248 = !DILocation(line: 0, scope: !1245)
!1249 = !DILocation(line: 8, column: 22, scope: !1245)
!1250 = !DILocation(line: 8, column: 24, scope: !1245)
!1251 = distinct !DISubprogram(name: "noutputs", linkageName: "_ZNK7Element8noutputsEv", scope: !1172, file: !1173, line: 424, type: !1252, scopeLine: 425, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1254, retainedNodes: !1255)
!1252 = !DISubroutineType(types: !1253)
!1253 = !{!34, !1216}
!1254 = !DISubprogram(name: "noutputs", linkageName: "_ZNK7Element8noutputsEv", scope: !1172, file: !1173, line: 132, type: !1252, scopeLine: 132, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1255 = !{!1256}
!1256 = !DILocalVariable(name: "this", arg: 1, scope: !1251, type: !1221, flags: DIFlagArtificial | DIFlagObjectPointer)
!1257 = !DILocation(line: 0, scope: !1251)
!1258 = !DILocation(line: 426, column: 12, scope: !1251)
!1259 = !DILocation(line: 426, column: 5, scope: !1251)
!1260 = distinct !DISubprogram(name: "push", linkageName: "_ZNK7Element4Port4pushEP6Packet", scope: !1261, file: !1173, line: 609, type: !1278, scopeLine: 610, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, declaration: !1277, retainedNodes: !1293)
!1261 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "Port", scope: !1172, file: !1173, line: 214, size: 128, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !1262, identifier: "_ZTSN7Element4PortE")
!1262 = !{!1263, !1265, !1266, !1271, !1274, !1277, !1280, !1283, !1287, !1290}
!1263 = !DIDerivedType(tag: DW_TAG_member, name: "_e", scope: !1261, file: !1173, line: 231, baseType: !1264, size: 64)
!1264 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1172, size: 64)
!1265 = !DIDerivedType(tag: DW_TAG_member, name: "_port", scope: !1261, file: !1173, line: 232, baseType: !34, size: 32, offset: 64)
!1266 = !DISubprogram(name: "active", linkageName: "_ZNK7Element4Port6activeEv", scope: !1261, file: !1173, line: 216, type: !1267, scopeLine: 216, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1267 = !DISubroutineType(types: !1268)
!1268 = !{!53, !1269}
!1269 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1270, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1270 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !1261)
!1271 = !DISubprogram(name: "element", linkageName: "_ZNK7Element4Port7elementEv", scope: !1261, file: !1173, line: 217, type: !1272, scopeLine: 217, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1272 = !DISubroutineType(types: !1273)
!1273 = !{!1264, !1269}
!1274 = !DISubprogram(name: "port", linkageName: "_ZNK7Element4Port4portEv", scope: !1261, file: !1173, line: 218, type: !1275, scopeLine: 218, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1275 = !DISubroutineType(types: !1276)
!1276 = !{!34, !1269}
!1277 = !DISubprogram(name: "push", linkageName: "_ZNK7Element4Port4pushEP6Packet", scope: !1261, file: !1173, line: 220, type: !1278, scopeLine: 220, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1278 = !DISubroutineType(types: !1279)
!1279 = !{null, !1269, !78}
!1280 = !DISubprogram(name: "pull", linkageName: "_ZNK7Element4Port4pullEv", scope: !1261, file: !1173, line: 221, type: !1281, scopeLine: 221, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1281 = !DISubroutineType(types: !1282)
!1282 = !{!78, !1269}
!1283 = !DISubprogram(name: "assign", linkageName: "_ZN7Element4Port6assignEbPS_i", scope: !1261, file: !1173, line: 227, type: !1284, scopeLine: 227, flags: DIFlagPublic | DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1284 = !DISubroutineType(types: !1285)
!1285 = !{null, !1286, !53, !1264, !34}
!1286 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1261, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!1287 = !DISubprogram(name: "Port", scope: !1261, file: !1173, line: 247, type: !1288, scopeLine: 247, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1288 = !DISubroutineType(types: !1289)
!1289 = !{null, !1286}
!1290 = !DISubprogram(name: "assign", linkageName: "_ZN7Element4Port6assignEbPS_S1_i", scope: !1261, file: !1173, line: 248, type: !1291, scopeLine: 248, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized)
!1291 = !DISubroutineType(types: !1292)
!1292 = !{null, !1286, !53, !1264, !1264, !34}
!1293 = !{!1294, !1296}
!1294 = !DILocalVariable(name: "this", arg: 1, scope: !1260, type: !1295, flags: DIFlagArtificial | DIFlagObjectPointer)
!1295 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !1270, size: 64)
!1296 = !DILocalVariable(name: "p", arg: 2, scope: !1260, file: !1173, line: 609, type: !78)
!1297 = !DILocation(line: 0, scope: !1260)
!1298 = !DILocation(line: 609, column: 29, scope: !1260)
!1299 = !DILocation(line: 611, column: 5, scope: !1260)
!1300 = !{!1301, !1225, i64 0}
!1301 = !{!"_ZTSN7Element4PortE", !1225, i64 0, !1230, i64 8}
!1302 = !DILocation(line: 633, column: 5, scope: !1260)
!1303 = !DILocation(line: 633, column: 14, scope: !1260)
!1304 = !{!1301, !1230, i64 8}
!1305 = !DILocation(line: 633, column: 21, scope: !1260)
!1306 = !DILocation(line: 633, column: 9, scope: !1260)
!1307 = !{!1308, !1308, i64 0}
!1308 = !{!"vtable pointer", !1227, i64 0}
!1309 = !DILocation(line: 636, column: 1, scope: !1260)
